...
BEHAVIOR_FIELDS = (
    ...
    "JEALOUSY_ENABLED",
    "JEALOUSY_HOURS",
    "RIVAL_JEALOUSY_ENABLED",
    "RIVAL_JEALOUSY_LEVEL",
    "PERSONA_MODE",
    "RELATIONSHIP_STAGE",
    "ENERGY_ENABLED",
    "CLOSENESS_ENABLED",
    ...
    "LIFE_FEED_ENABLED",
    "AUTONOMOUS_ENABLED",
    "INITIATIVE_TICK_MINUTES",
    "INITIATIVE_MIN_GAP_MINUTES",
    "SCREEN_WATCH_ENABLED",
    "SCREEN_WATCH_MONITOR",
    "SCREEN_WATCH_MAX_WIDTH",
    "SCREEN_WATCH_JPEG_QUALITY",
)
