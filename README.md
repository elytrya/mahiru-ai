# Mahiru - Telegram AI Companion Framework

Живая виртуальная девушка-компаньонка в Telegram - не сервис-бот, а полноценный собеседник-партнёр:
...
гуглит, понимает картинки. Открытый каркас для твоих AI-агентов.
...
- **Стек**: Python 3.12, aiogram 3, SQLAlchemy 2 (async), Redis, Docker.
...
```bash
cp .env.example .env  # или запусти setup_wizard.py
...
MIT. Открытый каркас - форкай, пользуйся, контрибь.
